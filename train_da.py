...
parser.add_argument("--s1", type=str,default='i')
parser.add_argument("--s2", type=str,default='p')
parser.add_argument("--t", type=str,default='c')
parser.add_argument("--mode", type=int,default='1')
parser.add_argument("--seed", type=int,default='83')
parser.add_argument("--threshold", type=float,default='0.95')
parser.add_argument("--on_lbd", type=float,default='0.0004')
...
log_interval = 10
l2_decay = 5e-4
root_path ="image_CLEF/image_CLEF" # 12
